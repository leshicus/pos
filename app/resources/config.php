...
//	define('BETTING_DB_PASS', 'bettingbetting123');
    define('SITE_ROOT_URL', 'http://newpos.dev.badbin.ru/');
...
//	define('ENABLE_VOCXOD', 1);
	...
	define('WS_ADDRESS', 'http://newpos.dev.badbin.ru:15855/');
	define('FAYE_WS_ADDRESS', 'http://newpos.dev.badbin.ru:9292/faye');
