[// убрал markets.main.noDraw, markets.main.win, coeff_ODDS_FT_0ODDS, _H, _A -то что дублируется в mainline (иначе лишние навигационные кнопки печатает)
    {
